...
class GenericView:
    ...
    @classmethod
    def generate(cls,table, name, category=None, fkeys=[], can_delete_item=False, custom_column_formatter=None, custom_column_editable_list=None, endpoint=None, post_creation_funcs=None, cols=[], column_default_sort_in=('id', True)):
        class View(AdminModelView, BaseView):
